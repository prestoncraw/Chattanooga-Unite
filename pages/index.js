    ...
    <div className={styles.container}>
      ...
      <NavBar/>
        ...
        <div className={styles["blueBackground"] + " " + styles["left"]}>
          ...
          <button className={styles.btn_outline_dark}>Learn More <i class="fa-solid fa-arrow-right"></i></button>
        </div>
        ...
        <div className={styles["grayBackground"] + " " + styles["right"]}>
          <div className={styles.red_decoration}></div>
            ...
            <button className={styles.btn_outline_light}>Learn More <i class="fa-solid fa-arrow-right"></i></button>
        </div>
